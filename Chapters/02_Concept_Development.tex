...
% While experience guides the assessment, having objective density data allows for precise validation of planned capacities against real-world conditions. This documentation becomes invaluable for post-event reviews and for clearly communicating the rationale behind safety-driven layout recommendations to other departments, addressing a noted challenge of justifying needs based purely on subjective assessment. This analytical need is supported by the frameworks discussing density thresholds and risk (Still Chapters 3, 9; ESA Guide Section 8.4.1.1).

% While Roskilde Festival employs these thorough, framework-informed workflows, the reliance on manual observation, experience-based estimation, and the challenge of systematically capturing and communicating quantitative data highlight opportunities for tools that can provide persistent, objective, and easily visualized insights into crowd dynamics, thereby potentially enhancing planning accuracy, internal communication, and long-term knowledge retention within the safety team.
% It may seem that Roskilde Festival's approach is already data-driven, however calculations are based on intuition and experience, rather than objective data. 
